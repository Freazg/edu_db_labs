...
6. Якщо проект з таким іменем вже існує, генерується **NotUniqueProjectName**.
7. Якщо перевірка успішна, система створює новий проект.
8. Користувач переходить до нового проекту.
...
### 4. Додавання учасника до проекту
...
**Виключні ситуації**:
- Не заповнені обов'язкові поля — **NoEssentialDataException**

**Основний сценарій**:
1. Користувач натискає кнопку "Створити завдання".
2. Вводить назву завдання, опис, статус (todo/in progress/done/in review), призначеного користувача та дедлайн.
3. Натискає кнопку "Створити".
4. Система перевіряє наявність обов’язкових полів.
5. Система створює завдання та відображає його в проекті.
6. Система повідомляє відповідальних користувачів.
## Функціональність
