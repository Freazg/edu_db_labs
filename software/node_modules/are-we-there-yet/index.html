...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>tracker<span class="token punctuation">.</span><span class="token function">completed</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token comment">// 1</span>
</code></pre></div><ul><li><p>tracker.addUnit(<strong>otherTracker</strong>, <strong>weight</strong>)</p> <ul><li><strong>otherTracker</strong> - Any of the other are-we-there-yet tracker objects</li> <li><strong>weight</strong> <em>(optional)</em> - The weight to give the tracker, defaults to 1.</li></ul></li></ul> <p>Adds the <strong>otherTracker</strong> to this aggregation group. The weight determines
how long you expect this tracker to take to complete in proportion to other
units.  So for instance, if you add one tracker with a weight of 1 and
another with a weight of 2, you're saying the second will take twice as long
to complete as the first.  As such, the first will account for 33% of the
completion of this tracker and the second will account for the other 67%.</p> <p>Returns <strong>otherTracker</strong>.</p> <ul><li>var subGroup = tracker.newGroup(<strong>name</strong>, <strong>weight</strong>)</li></ul> <p>The above is exactly equivalent to:</p> <div class="language-javascript extra-class"><pre class="language-javascript"><code>  <span class="token keyword">var</span> subGroup <span class="token operator">=</span> tracker<span class="token punctuation">.</span><span class="token function">addUnit</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">TrackerGroup</span><span class="token punctuation">(</span>name<span class="token punctuation">)</span><span class="token punctuation">,</span> weight<span class="token punctuation">)</span>
</code></pre></div><ul><li>var subItem = tracker.newItem(<strong>name</strong>, <strong>todo</strong>, <strong>weight</strong>)</li></ul> <p>The above is exactly equivalent to:</p> <div class="language-javascript extra-class"><pre class="language-javascript"><code>  <span class="token keyword">var</span> subItem <span class="token operator">=</span> tracker<span class="token punctuation">.</span><span class="token function">addUnit</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">Tracker</span><span class="token punctuation">(</span>name<span class="token punctuation">,</span> todo<span class="token punctuation">)</span><span class="token punctuation">,</span> weight<span class="token punctuation">)</span>
</code></pre></div><ul><li>var subStream = tracker.newStream(<strong>name</strong>, <strong>todo</strong>, <strong>weight</strong>)</li></ul> <p>The above is exactly equivalent to:</p> <div class="language-javascript extra-class"><pre class="language-javascript"><code>  <span class="token keyword">var</span> subStream <span class="token operator">=</span> tracker<span class="token punctuation">.</span><span class="token function">addUnit</span><span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">TrackerStream</span><span class="token punctuation">(</span>name<span class="token punctuation">,</span> todo<span class="token punctuation">)</span><span class="token punctuation">,</span> weight<span class="token punctuation">)</span>
</code></pre></div><ul><li>console.log( tracker.debug() )</li></ul> <p>Returns a tree showing the completion of this tracker group and all of its
children, including recursively entering all of the children.</p> <h1 id="tracker"><a href="#tracker" class="header-anchor">#</a> Tracker</h1> <ul><li><p>var tracker = new Tracker(<strong>name</strong>, <strong>todo</strong>)</p> <ul><li><strong>name</strong> <em>(optional)</em> The name of this counter to report in change
events.  Defaults to undefined.</li> <li><strong>todo</strong> <em>(optional)</em> The amount of work todo (a number). Defaults to 0.</li></ul></li></ul> <p>Ordinarily these are constructed as a part of a tracker group (via
<code>newItem</code>).</p> <ul><li>var completed = tracker.completed()</li></ul> <p>Returns the ratio of completed work to work to be done. Range of 0 to 1. If
total work to be done is 0 then it will return 0.</p> <ul><li><p>tracker.addWork(<strong>todo</strong>)</p> <ul><li><strong>todo</strong> A number to add to the amount of work to be done.</li></ul></li></ul> <p>Increases the amount of work to be done, thus decreasing the completion
percentage.  Triggers a <code>change</code> event.</p> <ul><li><p>tracker.completeWork(<strong>completed</strong>)</p> <ul><li><strong>completed</strong> A number to add to the work complete</li></ul></li></ul> <p>Increase the amount of work complete, thus increasing the completion percentage.
Will never increase the work completed past the amount of work todo. That is,
percentages &gt; 100% are not allowed. Triggers a <code>change</code> event.</p> <ul><li>tracker.finish()</li></ul> <p>Marks this tracker as finished, tracker.completed() will now be 1. Triggers
a <code>change</code> event.</p> <h1 id="trackerstream"><a href="#trackerstream" class="header-anchor">#</a> TrackerStream</h1> <ul><li><p>var tracker = new TrackerStream(<strong>name</strong>, <strong>size</strong>, <strong>options</strong>)</p> <ul><li><strong>name</strong> <em>(optional)</em> The name of this counter to report in change
events.  Defaults to undefined.</li> <li><strong>size</strong> <em>(optional)</em> The number of bytes being sent through this stream.</li> <li><strong>options</strong> <em>(optional)</em> A hash of stream options</li></ul></li></ul> <p>The tracker stream object is a pass through stream that updates an internal
tracker object each time a block passes through.  It's intended to track
downloads, file extraction and other related activities. You use it by piping
your data source into it and then using it as your data source.</p> <p>If your data has a length attribute then that's used as the amount of work
completed when the chunk is passed through.  If it does not (eg, object
streams) then each chunk counts as completing 1 unit of work, so your size
should be the total number of objects being streamed.</p> <ul><li><p>tracker.addWork(<strong>todo</strong>)</p> <ul><li><strong>todo</strong> Increase the expected overall size by <strong>todo</strong> bytes.</li></ul></li></ul> <p>Increases the amount of work to be done, thus decreasing the completion
percentage.  Triggers a <code>change</code> event.</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/59.4819900e.js" defer></script>
  </body>
</html>
