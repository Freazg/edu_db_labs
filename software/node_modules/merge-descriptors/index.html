...
<html lang="en-US">
  <head>
    ...
    <title>merge-descriptors | Назва проєкту</title>
...
</code></pre></div><h2 id="api"><a href="#api" class="header-anchor">#</a> API</h2> <h3 id="merge-destination-source"><a href="#merge-destination-source" class="header-anchor">#</a> merge(destination, source)</h3> <p>Redefines <code>destination</code>'s descriptors with <code>source</code>'s. The return value is the
<code>destination</code> object.</p> <h3 id="merge-destination-source-false"><a href="#merge-destination-source-false" class="header-anchor">#</a> merge(destination, source, false)</h3> <p>Defines <code>source</code>'s descriptors on <code>destination</code> if <code>destination</code> does not have
a descriptor by the same name. The return value is the <code>destination</code> object.</p> <h2 id="license"><a href="#license" class="header-anchor">#</a> License</h2> <p><a href="LICENSE">MIT</a></p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/172.541e845d.js" defer></script>
  </body>
</html>
