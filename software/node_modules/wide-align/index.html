...
</code></pre></div><h3 id="functions"><a href="#functions" class="header-anchor">#</a> Functions</h3> <h4 id="align-center-str-length-→-str"><a href="#align-center-str-length-→-str" class="header-anchor">#</a> <code>align.center(str, length)</code> → <code>str</code></h4> <p>Returns <em>str</em> with spaces added to both sides such that that it is <em>length</em>
chars long and centered in the spaces.</p> <h4 id="align-left-str-length-→-str"><a href="#align-left-str-length-→-str" class="header-anchor">#</a> <code>align.left(str, length)</code> → <code>str</code></h4> <p>Returns <em>str</em> with spaces to the right such that it is <em>length</em> chars long.</p> <h3 id="align-right-str-length-→-str"><a href="#align-right-str-length-→-str" class="header-anchor">#</a> <code>align.right(str, length)</code> → <code>str</code></h3> <p>Returns <em>str</em> with spaces to the left such that it is <em>length</em> chars long.</p> <h3 id="origins"><a href="#origins" class="header-anchor">#</a> Origins</h3> <p>These functions were originally taken from
<a href="https://npmjs.com/package/cliui" target="_blank" rel="noopener noreferrer">cliui<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>. Changes include switching to the
MUCH faster pad generation function from
<a href="https://npmjs.com/package/lodash" target="_blank" rel="noopener noreferrer">lodash<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>, making center alignment pad
both sides and adding left alignment.</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/292.ff812607.js" defer></script>
  </body>
</html>
