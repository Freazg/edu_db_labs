...
that you encourage your users to override this via config.</p> <h3 id="unix-like-operating-systems"><a href="#unix-like-operating-systems" class="header-anchor">#</a> Unix Like Operating Systems</h3> <p>We look at the environment variables <code>LC_ALL</code>, <code>LC_CTYPE</code>, and <code>LANG</code> in
...
as well, AFAIK it's always copied into the environment.</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/145.101aef47.js" defer></script>
  </body>
</html>
