...
<html lang="en-US">
  <head>
    ...
    <title>Tools | Назва проєкту</title>
...
</code></pre></div><ol start="4"><li>In function where you need to Unwrap the ObjectWrap in NAN like <code>[ClassName]* native = Nan::ObjectWrap::Unwrap&lt;[ClassName]&gt;(info.This());</code>, use <code>this</code> pointer directly as the unwrapped object as each ObjectWrap instance is associated with a unique object instance.</li></ol> <p>If you still find issues after following this guide, please leave us an issue describing your problem and we will try to resolve it.</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/192.c8356b6c.js" defer></script>
  </body>
</html>
