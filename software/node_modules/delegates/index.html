...
<html lang="en-US">
  <head>
    ...
    <title>delegates | Назва проєкту</title>
...
<span class="token function">delegate</span><span class="token punctuation">(</span>proto<span class="token punctuation">,</span> <span class="token string">'request'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">.</span><span class="token function">access</span><span class="token punctuation">(</span><span class="token string">'host'</span><span class="token punctuation">)</span>
  ...
  <span class="token punctuation">.</span><span class="token function">getter</span><span class="token punctuation">(</span><span class="token string">'ip'</span><span class="token punctuation">)</span>
</code></pre></div><h1 id="api"><a href="#api" class="header-anchor">#</a> API</h1> <h2 id="delegate-proto-prop"><a href="#delegate-proto-prop" class="header-anchor">#</a> Delegate(proto, prop)</h2> <p>Creates a delegator instance used to configure using the <code>prop</code> on the given
<code>proto</code> object. (which is usually a prototype)</p> <h2 id="delegate-method-name"><a href="#delegate-method-name" class="header-anchor">#</a> Delegate#method(name)</h2> <p>Allows the given method <code>name</code> to be accessed on the host.</p> <h2 id="delegate-getter-name"><a href="#delegate-getter-name" class="header-anchor">#</a> Delegate#getter(name)</h2> <p>Creates a &quot;getter&quot; for the property with the given <code>name</code> on the delegated
object.</p> <h2 id="delegate-setter-name"><a href="#delegate-setter-name" class="header-anchor">#</a> Delegate#setter(name)</h2> <p>Creates a &quot;setter&quot; for the property with the given <code>name</code> on the delegated
object.</p> <h2 id="delegate-access-name"><a href="#delegate-access-name" class="header-anchor">#</a> Delegate#access(name)</h2> <p>Creates an &quot;accessor&quot; (ie: both getter <em>and</em> setter) for the property with the
given <code>name</code> on the delegated object.</p> <h2 id="delegate-fluent-name"><a href="#delegate-fluent-name" class="header-anchor">#</a> Delegate#fluent(name)</h2> <p>A unique type of &quot;accessor&quot; that works for a &quot;fluent&quot; API. When called as a
getter, the method returns the expected value. However, if the method is called
with a value, it will return itself so it can be chained. For example:</p> <div class="language-js extra-class"><pre class="language-js"><code><span class="token function">delegate</span><span class="token punctuation">(</span>proto<span class="token punctuation">,</span> <span class="token string">'request'</span><span class="token punctuation">)</span>
  <span class="token punctuation">.</span><span class="token function">fluent</span><span class="token punctuation">(</span><span class="token string">'query'</span><span class="token punctuation">)</span>

<span class="token comment">// getter</span>
<span class="token keyword">var</span> q <span class="token operator">=</span> request<span class="token punctuation">.</span><span class="token function">query</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

<span class="token comment">// setter (chainable)</span>
request
  <span class="token punctuation">.</span><span class="token function">query</span><span class="token punctuation">(</span><span class="token punctuation">{</span> <span class="token literal-property property">a</span><span class="token operator">:</span> <span class="token number">1</span> <span class="token punctuation">}</span><span class="token punctuation">)</span>
  <span class="token punctuation">.</span><span class="token function">query</span><span class="token punctuation">(</span><span class="token punctuation">{</span> <span class="token literal-property property">b</span><span class="token operator">:</span> <span class="token number">2</span> <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/94.03a20ac4.js" defer></script>
  </body>
</html>
