...
<html lang="en-US">
  <head>
    ...
    <title>statuses | Назва проєкту</title>
...
</code></pre></div><h3 id="status-code"><a href="#status-code" class="header-anchor">#</a> status(code)</h3> <p>Returns the status message string for a known HTTP status code. The code
may be a number or a string. An error is thrown for an unknown status code.</p> <div class="language-js extra-class"><pre class="language-js"><code><span class="token function">status</span><span class="token punctuation">(</span><span class="token number">403</span><span class="token punctuation">)</span> <span class="token comment">// =&gt; 'Forbidden'</span>
<span class="token function">status</span><span class="token punctuation">(</span><span class="token string">'403'</span><span class="token punctuation">)</span> <span class="token comment">// =&gt; 'Forbidden'</span>
<span class="token function">status</span><span class="token punctuation">(</span><span class="token number">306</span><span class="token punctuation">)</span> <span class="token comment">// throws</span>
</code></pre></div><h3 id="status-msg"><a href="#status-msg" class="header-anchor">#</a> status(msg)</h3> <p>Returns the numeric status code for a known HTTP status message. The message
is case-insensitive. An error is thrown for an unknown status message.</p> <div class="language-js extra-class"><pre class="language-js"><code><span class="token function">status</span><span class="token punctuation">(</span><span class="token string">'forbidden'</span><span class="token punctuation">)</span> <span class="token comment">// =&gt; 403</span>
...
<span class="token function">status</span><span class="token punctuation">(</span><span class="token string">'foo'</span><span class="token punctuation">)</span> <span class="token comment">// throws</span>
</code></pre></div><h3 id="status-codes"><a href="#status-codes" class="header-anchor">#</a> status.codes</h3> <p>Returns an array of all the status codes as <code>Integer</code>s.</p> <h3 id="status-code-msg"><a href="#status-code-msg" class="header-anchor">#</a> status.code[msg]</h3> <p>Returns the numeric status code for a known status message (in lower-case),
otherwise <code>undefined</code>.</p> <div class="language-js extra-class"><pre class="language-js"><code>status<span class="token punctuation">[</span><span class="token string">'not found'</span><span class="token punctuation">]</span> <span class="token comment">// =&gt; 404</span>
...
</code></pre></div><h3 id="status-message-code"><a href="#status-message-code" class="header-anchor">#</a> status.message[code]</h3> <p>Returns the string message for a known numeric status code, otherwise
<code>undefined</code>. This object is the same format as the
<a href="https://nodejs.org/dist/latest/docs/api/http.html#http_http_status_codes" target="_blank" rel="noopener noreferrer">Node.js http module <code>http.STATUS_CODES</code><span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>.</p> <div class="language-js extra-class"><pre class="language-js"><code>status<span class="token punctuation">.</span>message<span class="token punctuation">[</span><span class="token number">404</span><span class="token punctuation">]</span> <span class="token comment">// =&gt; 'Not Found'</span>
...
status<span class="token punctuation">.</span>retry<span class="token punctuation">[</span><span class="token number">503</span><span class="token punctuation">]</span> <span class="token comment">// =&gt; true</span>
    ...
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/269.53898d41.js" defer></script>
  </body>
</html>
