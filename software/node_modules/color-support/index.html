...
<html lang="en-US">
  <head>
    ...
    <title>color-support | Назва проєкту</title>
...
color, ansi, cygwin, or linux <code>TERM</code> will get 16 colors.</p></li> <li><p>If <code>COLORTERM</code> environment variable is set, then support 16 colors.</p></li> <li><p>At this point, we assume that color is not supported.</p></li></ol> <h2 id="usage"><a href="#usage" class="header-anchor">#</a> USAGE</h2> <div class="language-javascript extra-class"><pre class="language-javascript"><code><span class="token keyword">var</span> testColorSupport <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'color-support'</span><span class="token punctuation">)</span>
...
</code></pre></div><p>If you don't have any options to set, you can also just look at the
...
doesn't allow you to set options.)</p> <div class="language-javascript extra-class"><pre class="language-javascript"><code><span class="token keyword">var</span> colorSupport <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'color-support'</span><span class="token punctuation">)</span>
...
<a href="http://npm.im/~sindresorhus" target="_blank" rel="noopener noreferrer">Sindre Sorhus<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>.</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/81.ed5b8875.js" defer></script>
  </body>
</html>
