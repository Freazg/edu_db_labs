...
<html lang="en-US">
  <head>
    ...
    <title>Polyfill for Object.setPrototypeOf | Назва проєкту</title>
...
</code></pre></div><p>TypeScript is also supported:</p> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token keyword">import</span> setPrototypeOf <span class="token keyword">from</span> <span class="token string">'setprototypeof'</span>
</code></pre></div></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/257.9cb294d7.js" defer></script>
  </body>
</html>
