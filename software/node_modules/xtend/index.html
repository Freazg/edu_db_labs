...
<html lang="en-US">
  <head>
    ...
    <title>xtend | Назва проєкту</title>
...
<span class="token keyword">var</span> combination <span class="token operator">=</span> <span class="token function">extend</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    ...
    <span class="token literal-property property">b</span><span class="token operator">:</span> <span class="token string">&quot;c&quot;</span>
...
</code></pre></div><h2 id="stability-status-locked"><a href="#stability-status-locked" class="header-anchor">#</a> Stability status: Locked</h2> <h2 id="mit-licensed"><a href="#mit-licensed" class="header-anchor">#</a> MIT Licensed</h2></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"><!----></div></div>
    <script src="/edu_db_labs/assets/js/app.b4446a62.js" defer></script><script src="/edu_db_labs/assets/js/2.c940f4cf.js" defer></script><script src="/edu_db_labs/assets/js/1.444b6f58.js" defer></script><script src="/edu_db_labs/assets/js/294.322e8b16.js" defer></script>
  </body>
</html>
